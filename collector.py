...
from lbstats.daemon import LoadbalancerStatisticsCollectorDaemon
from lbstats.log import init_log

if __name__ == '__main__':

	logger, loghandler = init_log(config.COLLECTOR_LOGFILE, 'loadbalancer_statistics_collector')

	app = LoadbalancerStatisticsCollectorDaemon()
